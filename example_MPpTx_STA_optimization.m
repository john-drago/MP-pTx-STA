...
addpath( fullfile( currDir, 'data' ) );
addpath( fullfile( currDir, 'func' ) );

%% Load Fields
b1p = load( fullfile( currDir, 'data', 'birdcage_fields.mat' ) );
bs = load( fullfile( currDir, 'data', '32ch_fields.mat' ) );
db0 = load( fullfile( currDir, 'data', 'db0_fields.mat' ) );
rngState = load( fullfile( currDir, 'data', 'rng_state.mat' ) );
